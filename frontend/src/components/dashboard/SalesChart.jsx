...
import { FaChartBar, FaCalendarDay, FaDownload } from 'react-icons/fa';
      ...
      {data.length > 0 ? (
                  ...
                  <div className="w-full flex justify-center">
                    <div
                      className={`w-8 max-w-full rounded-t transition-all duration-500 hover:opacity-80 ${
                        index % 2 === 0 ? 'bg-gradient-to-t from-blue-500 to-blue-400' : 'bg-gradient-to-t from-cyan-500 to-cyan-400'
                      }`}
        ...
        <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
          <div className="text-center">
            <FaChartBar className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-gray-600" />
