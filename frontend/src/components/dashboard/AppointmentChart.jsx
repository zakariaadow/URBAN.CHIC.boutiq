// src/components/dashboard/AppointmentChart.jsx
import React, { useState } from 'react';
import { useTranslation } from 'react-i18next';
import { FaCalendarCheck, FaCalendarDay, FaDownload } from 'react-icons/fa';
      ...
      {data.length > 0 ? (
                  ...
                  <div className="w-full flex justify-center">
                    <div
                      className={`w-8 max-w-full rounded-t transition-all duration-500 hover:opacity-80 ${
                        index % 2 === 0 ? 'bg-gradient-to-t from-green-500 to-green-400' : 'bg-gradient-to-t from-emerald-500 to-emerald-400'
                      }`}
        ...
        <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
          <div className="text-center">
            <FaCalendarCheck className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-gray-600" />
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-green-600 dark:text-green-400">
              {data.reduce((max, d) => d.value > max.value ? d : max, data[0]).label}
            </p>
          </div>
          <div>
