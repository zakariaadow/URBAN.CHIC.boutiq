...
import { FaChartLine, FaCalendarDay, FaDownload } from 'react-icons/fa';
      ...
      {data.length > 0 ? (
                  ...
                  <div className="w-full flex justify-center">
                    <div
                      className={`w-8 max-w-full rounded-t transition-all duration-500 hover:opacity-80 ${
                        isPositive ? 'bg-gradient-to-t from-purple-500 to-purple-400' : 'bg-red-400'
                      }`}
        ...
        <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
          <div className="text-center">
            <FaChartLine className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-gray-600" />
