...
import { FaUsers, FaCalendarDay, FaDownload } from 'react-icons/fa';
      ...
      {data.length > 0 ? (
                  ...
                  <div className="w-full flex justify-center">
                    <div
                      className={`w-8 max-w-full rounded-t transition-all duration-500 hover:opacity-80 ${
                        index % 2 === 0 ? 'bg-gradient-to-t from-indigo-500 to-indigo-400' : 'bg-gradient-to-t from-purple-500 to-purple-400'
                      }`}
        ...
        <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
          <div className="text-center">
            <FaUsers className="w-12 h-12 mx-auto mb-2 text-gray-300 dark:text-gray-600" />
      ...
      {data.length > 0 && (
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900 dark:text-white">
              {Math.round(data.reduce((sum, d) => sum + d.value, 0) * 0.85)}
            </p>
          </div>
        </div>
      )}
